...
export class TitleEditor extends React.Component<StyleProps<TitleEditorProps, typeof styles>> {
    ...
    @observable private value = this.props.outline.title || ""
    ...
    public render() {
        ...
        if (!this.isEditing) {
            return (
                <div className={classes.presenterContainer}>
                    <a onClick={this.enableEditing} className={classes.editControl}>
                        <Octicon name="pencil" />
                    </a>
                    <Typography variant="title" className={classes.presenter}>
        ...
        return (
            <div className={classes.presenterContainer}>
                ...
                <a onClick={this.confirmEdit} className={classes.btnControl}>
                    <Octicon name="check" />
                </a>
                <a onClick={this.rejectEdit} className={classes.btnControl}>
                    <Octicon name="x" />
                </a>
            </div>
        )
